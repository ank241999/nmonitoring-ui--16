...
import { MatAutocompleteModule, MatCheckboxModule, MatDatepickerModule, MatFormFieldModule, MatNativeDateModule, MatRadioModule, MatSelectModule, MatIconModule, MatButtonModule, MatInputModule, MatSortModule, MatTableModule, MatPaginatorModule } from "@angular/material";
...
import { IScreenerMessageResponse } from "../../../../assets/interfaces/iresponse";
import { ReportService } from "../../../../assets/services/report.service";
import { ShareDataService } from "../../../../assets/services/share-data.service";
import { UserService } from "../../../../assets/services/user.service";
import { ScreenermessageComponent } from "./screenermessage.component";


export class screenermessageService {
  Iscreenermessage: IScreenerMessage = {
    date: 0,
    devices: "beta1, beta2",
    lane: "Lane1",
    gate: "Gate 1",
  ...
  iScreenerMessageList: IScreenerMessage[] = [];
  iScreenerMessageListData: IScreenerMessage;
  startDate: string = "";
  endDate: string = "";

  public getScreenerMessage(startDate, endDate): Observable<IScreenerMessageResponse> {
    this.iScreenerMessageList.push(this.iScreenerMessageListData);
    let mockResponse: IScreenerMessageResponse = {
      "status": 200,
      "data": this.iScreenerMessageList
    };
...
describe("ScreenermessageComponent", () => {
  let component: ScreenermessageComponent;
  let fixture: ComponentFixture<ScreenermessageComponent>;
  ...
  beforeEach(async () => {
    const reportServiceSpy = jasmine.createSpyObj('ReportService', ['getScreenerMessage']);
    reportServiceSpy.getScreenerMessage.and.returnValue(of());
    ...
    TestBed.configureTestingModule({
      declarations: [ScreenermessageComponent],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ScreenermessageComponent);
